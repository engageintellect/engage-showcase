...
hoistedDependencies:
  ...
  /@sveltejs/vite-plugin-svelte-inspector/2.0.0(@sveltejs/vite-plugin-svelte@3.0.2)(svelte@4.2.12):
  ...
  /svelte-hmr/0.15.3(svelte@4.2.12):
    svelte-hmr: private
  /svelte2tsx/0.6.22(svelte@4.2.12)(typescript@5.2.2):
    svelte2tsx: private
  /svgo/2.8.0:
    svgo: private
  /tar-fs/3.0.4:
...
pendingBuilds: []
prunedAt: Thu, 07 Mar 2024 02:34:06 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
